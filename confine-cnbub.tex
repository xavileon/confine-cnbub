...
Roger Baig\IEEEauthorrefmark{3}%
}
\IEEEauthorblockA{%
...
\begin{figure*}[!t]
 ...
 \subfloat[][Research devices connected to an existing node (left) and a complete Community-Lab cloud with community and research devices (right)]{%
