...
\section{Confine integration in the existing networks}
...
\subsection{How the nodes are spread in a community}
...
\subsection{How the Confine nodes are spread in the community}
...
As shown in the figure \ref{fig:community_network_with_rd}, a research device (RD) without antennas is 
...
deployed. It means (as shown in figure \ref{fig:community_network_with_cloud_rd}) the installation of several 
