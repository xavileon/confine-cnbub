...
\textbf{Discussion}. There are three major characteristics which make the Community-Lab
...
components which come with additional equipment acquisition and
maintenance cost (e.g. increased energy consumption) for node
...
CONFINE Node System must be compatible with the original system used on
nodes in the CN.
...
complete the UCI-based \cite{uci} configuration template of the RD.  The
...
CONFINE management network (\emph{tinc} IPv6 overlay, see next point).
